...
const textColor = localStorage.getItem("chakra-ui-color-mode")
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        "https://dukhbhanjan.onrender.com/yantra"
      );
      setInLoading(false)
    ...
    try {
      if (editingProduct && editingProduct._id) {
        const res = await axios.put(
          `https://dukhbhanjan.onrender.com/yantr/${editingProduct._id}`,
          editingProduct
          );
        fetchData();
        handleCloseModal();
  ...
  const handleDelete = async (id) => {
    try {
      const res = await axios.delete(`https://dukhbhanjan.onrender.com/yantra/delete/${id}`);
...
const handleSubmit = async () => {
  try {
     ...
     const res = await axios.post("https://dukhbhanjan.onrender.com/yantra/create", formData);
